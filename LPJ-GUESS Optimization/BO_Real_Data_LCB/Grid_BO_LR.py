...
AS = {'Af': 'LCB', # Acquisition function: EI, PI, LCB
    'Af_param': 4, # Exploration parameter
...
for k in range(1,Nmax):
    ...
    if k == 4000:
        optimizer.af_param= 0 # switch to logPI
        optimizer.Af = optimizer.logPI
        optimizer.Af_g = optimizer.logPI_with_gradient
    ...
    x_,res= optimizer.AF_optimization_sampling2(10,500,grad= True) # returns the next evaluation point
    #ind = optimizer.ind
